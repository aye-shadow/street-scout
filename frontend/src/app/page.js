        ...
        <>
            ...
            <FontProvider>
                ...
                >
                    ...
                    <BoldWord text="local food vendors" /> that you can't
                    normally find on Google Maps with customers in their area.
                    We provide a platform for vendors to list their products and
                    for customers to find the best local food vendors in their
                    area.
                </Typography>
                <Typography position={"relaitve"} marginBottom={6}>
                    Whether you're looking for a <BoldWord text="quick snack" />{" "}
                    on the way home for college, or just craving some{" "}
                    <BoldWord text="spicy street food" /> on a weekend, we have
                    you covered!
                </Typography>
                <Typography
                    variant="h5"
